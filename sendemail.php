...
define( "RECIPIENT_NAME", "Solline Arquitetura" );
define( "RECIPIENT_EMAIL", "sollinearquitetura@gmail.com" );
...
if ( $userName && $senderEmail && $userPhone && $userSubject && $message) {
  ...
  header('Location: index.html?message=envio bem-sucedido');
}

else{
	//Set Location After Unsuccesssfull Submission
  	header('Location: index.html?message=falha ao enviar');	
}
